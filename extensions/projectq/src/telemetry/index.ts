...
import { AppinsightsKey, isTestExecution, isUnitTestExecution, PQSC_EXTENSION_ID } from "../common/constants";
...
function getTelemetryReporter() {
    ...
    const extensionId = PQSC_EXTENSION_ID;
    // eslint-disable-next-line @typescript-eslint/no-require-imports
...
export function sendTelemetryPythonEvent<P extends IEventNamePropertyMapping, E extends keyof P>(
    eventName: E,
