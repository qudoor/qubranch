...
import { logWarning, traceDecorators } from '../../../common/logging';
...
export class CondaService implements ICondaService {
    ...
    public async getCondaVersion(): Promise<SemVer | undefined> {
        ...
        logWarning(`Unable to parse Version of Conda, ${versionString}`);
     ...
     */
    @traceDecorators.verbose('Get Conda File from interpreter', TraceOptions.Arguments | TraceOptions.BeforeCall)
    @cache(120_000)
