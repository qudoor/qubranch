...
import { getEnvironmentInfoService, EnvironmentInfoServiceQueuePriority } from "./base/info/environmentInfoService";
...
class ComponentAdapter implements IComponentAdapter {
    ...
    public onDidCreate(resource: Resource, callback: () => void): vscode.Disposable {
        ...
        return this.api.onChanged((e) => {
            ...
            logVerbose(`Received event ${JSON.stringify(e)} file change event`);
            if (
