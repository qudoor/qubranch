...
import { BasicEnvInfo, ILocator, IPythonEnvsIterator, IResolvingLocator, PythonEnvUpdatedEvent, PythonLocatorQuery } from "../../locator";
...
export class PythonEnvsResolver implements IResolvingLocator {
    ...
    private async *iterEnvsIterator(
        ...
        let result: any = await iterator.next();
        while (!result.done) {
