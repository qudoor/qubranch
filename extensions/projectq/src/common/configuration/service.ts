...
import { ProjectQSettings } from '../configSettings';
import { isUnitTestExecution } from '../constants';
import { IConfigurationService, IProjectQSettings, IWatchableProjectQSettings } from '../types';
...
export class ConfigurationService implements IConfigurationService {
    ...
    public getSettings(resource?: Uri): IWatchableProjectQSettings {
        return ProjectQSettings.getInstance(resource, this.workspaceService);
    }
    ...
    public async updateSectionSetting(
        ...
        if (section === 'projectq' && configTarget !== ConfigurationTarget.Global) {
            settingsInfo = ProjectQSettings.getSettingsUriAndTarget(resource, this.workspaceService);
        }
    ...
    public async updateSetting(
        ...
        return this.updateSectionSetting('projectq', setting, value, resource, configTarget);
    }
