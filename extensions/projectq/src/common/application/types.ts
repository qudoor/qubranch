...
import { ColorTheme, Event, WindowState, MessageItem, QuickPickOptions, CancellationToken, QuickPickItem, OpenDialogOptions, Uri, SaveDialogOptions, InputBoxOptions, QuickPick, InputBox, Disposable, StatusBarAlignment, StatusBarItem, WorkspaceFolderPickOptions, WorkspaceFolder, ProgressOptions, Progress, TreeViewOptions, TreeView, OutputChannel, TextEditor, TextEditorEdit, ConfigurationChangeEvent, FileSystemWatcher, GlobPattern, WorkspaceConfiguration, WorkspaceFoldersChangeEvent, DecorationRenderOptions, TextDocument, TextDocumentChangeEvent, TextDocumentShowOptions, TextEditorDecorationType, TextEditorOptionsChangeEvent, TextEditorSelectionChangeEvent, TextEditorViewColumnChangeEvent, ViewColumn, WorkspaceEdit, UIKind, Terminal, TerminalOptions } from "vscode";
