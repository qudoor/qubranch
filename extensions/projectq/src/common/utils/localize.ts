...
export namespace OutputChannelNames {
    export const projectq = localize('OutputChannelNames.projectq', 'ProjectQ');
    export const projectqTest = localize('OutputChannelNames.projectqTest', 'ProjectQ Test Log');
}
